 ...
 */
const PLANILHA_RELACIONAMENTO_CASO_SERVICO_ID  =  PropertiesService.getScriptProperties().getProperty('PLANILHA_RELACIONAMENTO_CASO_SERVICO_ID');
 ...
 */
const PLANILHA_RELACIONAMENTO_CASO_ANTIGO_SERVICO_ID  =  PropertiesService.getScriptProperties().getProperty('PLANILHA_RELACIONAMENTO_CASO_ANTIGO_SERVICO_ID');
